# Changelog — Guest Hub Casco

All notable changes to the GuestHub canonical files (HTML, CSS, JS in `*.html`, `css/styles.css`, `js/lang.js`, `js/restaurants.js`, `staff/README.md`).
